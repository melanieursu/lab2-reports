...
public class AppStorage {
    ...
    public void load(String path) throws Exception {
        ...
        // проверяет целостность (до изменения данных в памяти)
        validator.validate(result);   // бросает экспешн при ошибке

        // только теперь заменяем данные в памяти
